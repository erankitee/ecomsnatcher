...
class FrontEndController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories = Category::where('status','1')->where('role','main')->get();
    ...
    public function cartupdate(Request $request)
    {
        ...
        # Get the approprate date fro request and set to data 
        $data = [
    ...
    public function cart()
    {
        ...
        $carts = new \stdClass();
        if (Session::has('uniqueid')){
            $carts = Cart::with('products')->where('uniqueid', Session::get('uniqueid'))->get();
            $sum = Cart::with('products')->where('uniqueid', Session::get('uniqueid'))->sum('cost');
        }
