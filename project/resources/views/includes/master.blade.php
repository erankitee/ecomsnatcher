...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/css/css1.css')}}" />
      <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/css/css2.css')}}" media="all" />

      <script type="text/javascript" src="{{ URL::asset('assets/js/js_snacher.js')}}"></script>
   </head>
   <body>
      <div id="cover"></div>
      <div class="theme2">
         ...
         <footer>
            ...
            <div class="text-right footerlink">
               {!! $settings[0]->footer !!}
            </div>
            </div>
         </footer>
